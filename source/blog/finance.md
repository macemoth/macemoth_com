...
Financial markets are supposed to be [https://www.youtube.com/watch?v=fDek6cYijxI](chaotic). In the seventies, academia was quite confident that financial markets process new information immediately (such as news about a company that may drive a stock higher). It concluded that it would therefore be impossible to predict the market with publicly available information, because the news' consequences are immediately absorbed by the market. They called such markets [https://en.wikipedia.org/wiki/Efficient-market_hypothesis](efficient markets). In this view, the market can be represented by a [https://en.wikipedia.org/wiki/Random_walk](random walk). To consistently make profit in an efficient market requires exploiting inefficiencies or insider information.
